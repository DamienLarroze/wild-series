 ...
 */
final class Version20221118094145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode DROP season_id_id, CHANGE season_id season_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season_id_id INT NOT NULL, CHANGE season_id season_id INT NOT NULL');
